...
python evalModels.py --channel Skim3Mu --signal MHc-70_MA-65 --background ttZ --epochs 100
python evalModels.py --channel Skim3Mu --signal MHc-160_MA-120 --background ttZ --epochs 100
