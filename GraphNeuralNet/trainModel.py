...
sigDataList = shuffle(rtfileToDataList(rtSig, isSignal=True, maxSize=50000), random_state=42); rtSig.Close()
bkgDataList = shuffle(rtfileToDataList(rtBkg, isSignal=False, maxSize=50000), random_state=42); rtBkg.Close()
