...
if args.channel == "Skim1E2Mu":
    promptSysts = ["L1Prefire", "PileupReweight", "MuonIDSF", "ElectronIDSF", "EMuTrigSF", "JetRes", "JetEn", "ElectronRes", "ElectronEn", "MuonEn"]
if args.channel == "Skim3Mu":
    promptSysts = ["L1Prefire", "PileupReweight", "MuonIDSF", "DblMuTrigSF", "JetRes", "JetEn", "MuonEn"]
...
if __name__ == "__main__":
    ...
    if args.method == "CutNCount":
        ...
        if args.channel == "Skim1E2Mu":
            ...
            print(manager.syststring(syst="EMuTrigSF", sysType="lnN", skip=["nonprompt", "conversion"]))
