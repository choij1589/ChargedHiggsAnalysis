...
graphs_stat = StandardLimitsFromJSONFile('limits/limits.{}.{}.HybridNew.Shape.json'.format(ERA, CHANNEL))
...
comp = graphs_stat["exp0"]
comp.SetLineColor(ROOT.kViolet)
comp.SetLineWidth(2)
comp.SetLineStyle(4)
comp.Draw("LSAME")
legend.AddEntry(comp, "Expected (stat only)", "L")
