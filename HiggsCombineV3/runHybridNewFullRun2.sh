...
# prepare datacard
combineCards.py era2016a=results/2016preVFP/Skim3Mu__GraphNet__/${MASSPOINT}/datacard.txt \
                era2016b=results/2016postVFP/Skim3Mu__GraphNet__/${MASSPOINT}/datacard.txt \
                era2017=results/2017/Skim3Mu__GraphNet__/${MASSPOINT}/datacard.txt \
                era2018=results/2018/Skim3Mu__GraphNet__/${MASSPOINT}/datacard.txt >> datacard.txt
...
combine -M HybridNew --LHCmode LHC-limits workspace.root --saveHybridResult -t -1 --fork 18 --expectedFromGrid 0.500     # median expected
